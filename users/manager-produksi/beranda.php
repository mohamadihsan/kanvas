        ...
        <div class="page-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <caption><h5><b>Monitoring Bahan Baku </b></h5></caption>
                    <div style="width:100%;">
                        <table class="table table-responsive table-bordered">
                            ...
                            <tbody>
                                <?php
                                // retrieve data dari API
                                $file = file_get_contents($url_api."tampilkan_data_stok_bahan_baku.php");
                                $json = json_decode($file, true);
                                $i=0;
                                if (count($json['data']) > 0) {
                                    while ($i < count($json['data'])) {
                                        ...
                                        if ($status_stok[$i] == 'tidak aman') {
                                            ...
                                            $status_stok[$i] = '<span class="label label-success label-white middle">
