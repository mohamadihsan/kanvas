            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div id="" class="collapse tampil">
                        <div class="well">
                            <form action="../action/pelanggan.php" method="post" class="myform">
                                ...
                                <table class="table table-renponsive">
                                    <caption>Masukkan Data Pelanggan:</caption>
                                    <tr>
                                        <td width="15%">ID Pelanggan</td>
                                        <td><input type="text" name="id_pelanggan" value="" class="form-control" placeholder="ID akan dibuat secara otomatis" readonly></td>
                                    </tr>
                                    <tr>
                                        <td width="15%">Nama Pelanggan</td>
                                        <td><input type="text" name="nama_pelanggan" value="" class="form-control" placeholder="" required></td>
                                    </tr>
                                    <tr>
                        ...
                        <table id="mytable" class="display" width="100%" cellspacing="0">
                            <thead>
                                <tr class="">
                                    ...
                                    <th width="12%" class="text-left">Alamat</th>
...
<div class="modal fade" id="hapus" role="dialog">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <form method="post" action="../action/pelanggan.php" class="myform">
                <div class="modal-body">
                    <input type="hidden" name="hapus" value="1" readonly>
                    <input type="hidden" name="id_pelanggan" readonly>
...
<script>
    function ubah(id_pelanggan, nama_pelanggan, alamat, no_telp, email){
        $('.well input[name=id_pelanggan]').val(id_pelanggan);
        $('.well input[name=nama_pelanggan]').val(nama_pelanggan);
    ...
    function hapus(id_pelanggan){
        $('.modal-body input[name=id_pelanggan]').val(id_pelanggan);
    }
    ...
    $(document).ready(function(){
        ...
        $('#mytable').DataTable({
                    "bProcessing": true,
                    "sAjaxSource": "<?php echo $base_url.'action/tampilkan_data_pelanggan.php' ?>",
                    "deferRender": true,
                    "select": true,
                    //"dom": 'Bfrtip',
                    //"scrollY": "300",
